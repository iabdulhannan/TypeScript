...
console.log(getUsersProperty(usersArray, 'home'))
...
const anotherStore = new StateObject<(string | number | boolean)[]>(['hello'])
anotherStore.state = ['123']
anotherStore.state = [123]
anotherStore.state = [false]
